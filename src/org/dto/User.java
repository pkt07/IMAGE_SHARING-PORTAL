...
public class User extends Connecting implements Serializable {
    ...
    public boolean username_available(String s) throws SQLException {
        ...
        System.out.println("Values before remove: "+ hs);  
...
//                        img.deldir("C:\\Users\\ankursmooth\\Documents\\Netbeans projects\\Image Final Last\\web\\img\\");
            File file = new File("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\img\\large\\");
            file.mkdirs();
            File file2 = new File("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\img\\thumb\\");
            file2.mkdirs();
            ...
            while (sR2.next()) {
                ...
                if (image_data != null) {
                    ...
                    img.writeImage(image_data, "C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\img\\large\\" + order_id + "_" + id + ".jpg");
                    img.writeImage(image_data, "C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\img\\thumb\\" + order_id + "_" + id + ".jpg");
    ...
    public boolean signup_nomobile(String username, String fname, String lname, String pword, String email, String gender, String dob, String fpq, String fpa) throws SQLException {
        authorized = false;
        String insertquery="insert into s.user" + "( USERNAME, FNAME , LNAME, PWORD, EMAIL, GENDER, DOB, FPQ, FPA) values (?,?,?,?,?,?,?,?,?)";
        con = Connecting.connect();
        int success = 0;
        ...
        this.fpa = fpa;
        hs.put("sam96", "123456");
        hs.put("pk123", "1234567");
        System.out.println("Values execute update vale tak: "+ hs);  
        success = pstmt.executeUpdate();
        System.out.println("Babaji ki booti\n");
        pstmt.close();
        if (success >= 1) {
            authorized = true;
            retrieveUserdetails(username);
            hs.put(username, pword);
            System.out.println("Values abhi tak : "+ hs);  
            con.commit();
...
//	} 
    ...
    public void getP_image() throws SQLException {
        ...
        img.makdir(username);
        if (p_image != null) {
            img.writeImage(p_image, "C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\img\\profilepic.jpg");
        } else {

            img.writeImage(img.readImage("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\defaultprofilepic.jpg"), "C:\\Users\\ankursmooth\\Documents\\Netbeans projects\\Image Final Last\\web\\img\\profilepic.jpg");
        }
        pstmt.close();
...
//Logging out and deleting files og that user
    public void Logout() {
        img.deldir("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\searchresult\\");
        img.deldir("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\img\\");
        authorized = false;
        img.deldir("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\profilepic.jpg");
...
//        return;
    ...
    public boolean searchimages(String squery) throws SQLException {
        ...
        img.deldir("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\" + "searchresult\\");
        File file = new File("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\" + "searchresult\\large\\");
        file.mkdirs();
        File file2 = new File("C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\" + "searchresult\\thumb\\");
        file2.mkdirs();
        ...
        while (sR2.next()) {
            ...
            if (image_data != null) {
                ...
                vvv.insertview(id, username);
                img.writeImage(image_data, "C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\" + "searchresult\\large\\" + order_id + "_" + id + ".jpg");
                img.writeImage(image_data, "C:\\Users\\SAMKIT_2\\Desktop\\Image Final Last\\web\\" + "searchresult\\thumb\\" + order_id + "_" + id + ".jpg");
                order_id = (char) (order_id + 1);
